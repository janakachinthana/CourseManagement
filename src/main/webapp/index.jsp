...
<%@page import="KDU.IS.Models.StudentCourse"%>
<%@page import="KDU.IS.Services.StudentCourseServiceImpl"%>
<%@page import="KDU.IS.Services.IStudentCourseService"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<body id="page-top">
	...
	<header class="masthead">
		<div class="container">
			<div class="masthead-subheading">Welcome To Self Defense
	...
	<section class="page-section bg-light" id="courses">
		<div class="container">
			...
			<div class="row">
				...
				ArrayList<Course> courseList = courseService.getCourses();
				...
				<div class="col-lg-4 col-sm-6 mb-4">
					...
					<div class="portfolio-item">
						<a class="portfolio-link"
							href="CourseView.jsp?courseID=<%=courseID%>">
						...
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading"><%=course.getCourseName()%></div>
							<div class="portfolio-caption-subheading text-muted">
								For
								<%=course.getSpecification()%></div>
						</div>
					</div>
				</div>
				<%
				...
				<div class="col-lg-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" src="assets/img/team/1.jpg"
							alt="..." />
						<h4>Shiranga Dissanayake</h4>
						<p class="text-muted">Developer</p>
						<a class="btn btn-dark btn-social mx-2" href="#!"><i
							class="fab fa-twitter"></i></a> <a
							class="btn btn-dark btn-social mx-2"
							href="https://www.facebook.com/shiranga.dissanayaka"><i
	...
	<!-- Course Grid-->
	<section class="page-section bg-light" id="myCourses">
		<div class="container">
			<div class="text-center">
				<h2 class="section-heading text-uppercase">My Courses</h2>
				<h3 class="section-subheading text-muted">Lorem ipsum dolor sit
					amet consectetur.</h3>
			</div>
			<div class="row">
				...
				ArrayList<StudentCourse> studentCourseList = studentCourseService.getStudentCourses();
						...
						for (Course course1 : courseList) {
							...
							for (StudentCourse studentCourse : studentCourseList) {
								...
								String loginStudentID = LoginUser.LoginUserID;
								 
								
								if (studentID.equals(loginStudentID) && courseID.equals(course1.getCourseID())) { 
				...
				<div class="col-lg-4 col-sm-6 mb-4">
					...
					<div class="portfolio-item">
						<a class="portfolio-link"
							href="Course.jsp?courseID=<%=courseID%>">
							<div class="portfolio-hover">
								<div class="portfolio-hover-content">
									<i class="fas fa-eye fa-3x"></i>
								</div>
						...
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading"><%=course1.getCourseName()%></div>
							<div class="portfolio-caption-subheading text-muted">
								For
								<%=course1.getSpecification()%></div>
						</div>
					</div>
				</div>
				<%
