			...
			<div class="card card-body mx-3 mx-md-4 mt-n6">
				<div class="row gx-4 mb-2">
					...
					<div class="col-auto my-auto">
						<div class="h-100">
							<h5 class="mb-1">KDU</h5>
							<p class="mb-0 font-weight-normal text-sm">Self Defense
								Learning</p>
						</div>
					</div>
					<div class="col-auto my-auto">
						<div class="h-100">
							<a href="formCourse.jsp" class="btn btn-info">Add Course</a>
						</div>
					</div>
				</div>
				<div class="row">
									...
									<div class="card card-blog card-plain">
										...
										<div class="card-body p-3">
											...
											<div
												...
												<form action="./courseView.jsp" method="POST">
