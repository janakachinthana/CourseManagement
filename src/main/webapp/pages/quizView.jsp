...
<body class="g-sidenav-show bg-gray-200">
	...
	<div
		...
		<div class="page-header min-height-150 border-radius-xl mt-4 ">
			<h2 class="mask  bg-info  text-center opacity-6 text-light"></h2>

			<div class="col text-center">
				<form action="./formQuiz.jsp" method="POST">
					<input type="hidden" name="lectureID" value="<%=LectureID%>" />
					<button class="btn btn-info" type="submit">Add Quiz</button>
				</form>
			</div>
		</div>
						...
						<div class="col-12 mt-4">
							<div class="row">
								...
								<div class=" col-md-12 mb-xl-0 mb-4">
									<div class="card card-blog card-plain bg-secondary">
										<div class="card-header p-0 mt-n4 mx-3">
											<h1 class="text-center bg-dark text-light"></h1>
											<a class="d-block shadow-xl border-radius-xl"> </a>
										</div>
										<div class="card-body p-3">
											<h3 class="text-center bg-dark text-light">
												<b><%=quiz.getQuizID()%></b>
											</h3>
											<br>
											<div
												class="d-flex align-items-center justify-content-between">
												<h3 class="text-light"><b><%=quiz.getQuestion()%> </b></h3>
											</div>
											<br>
											<br>
											<h5 class="mb-0 text-sm text-warning">
												<input type="radio" name="<%=quiz.getQuizID()%>"  >&nbsp;&nbsp;<b><%=quiz.getAns1()%></b>
											</h5>
											<h5 class="mb-0 text-sm text-warning">
												<input type="radio" name="<%=quiz.getQuizID()%>">&nbsp;&nbsp;<b><%=quiz.getAns2()%></b>
											</h5>
											<%
											if (!quiz.getAns3().equals("")) {
											%>
											<h5 class="mb-0 text-sm text-warning">
												<input type="radio" name="<%=quiz.getQuizID()%>">&nbsp;&nbsp;<b><%=quiz.getAns3()%></b>
											</h5>
											<%
											}
											%>
<%
											...
											%>
											<h5 class="mb-0 text-sm text-warning">
												<input type="radio" name="<%=quiz.getQuizID()%>">&nbsp;&nbsp;<b><%=quiz.getAns4()%></b>
											</h5>
											<%
											}
											%>
											...
											%>
											<h5 class="mb-0 text-sm text-warning">
												<input type="radio" name="<%=quiz.getQuizID()%>">&nbsp;&nbsp;<b><%=quiz.getAns5()%></b>
											</h5>
											<%
											}
											%>
