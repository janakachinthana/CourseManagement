<%@page import="KDU.IS.Models.User"%>
<%@page import="java.util.ArrayList"%>
<%@page import="KDU.IS.Services.UserServiceImpl"%>
<%@page import="KDU.IS.Services.IUserService"%>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="card my-4">
						<div
							...
							<div
								...
								<h6 class="text-white text-capitalize ps-3">New User
									Requests</h6>
							</div>
							<%
								...
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Designation</th>
											<th
									...
									<tbody>
										...
										<tr>
											...
											<td class="align-middle text-center text-sm"><span
												class="badge badge-sm bg-gradient-danger">Approvel
													Required</span></td>
				...
				<div class="col-12">
					<div class="card my-4">
						<div
							...
							<div
								class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
								<h6 class="text-white text-capitalize ps-3">Teacher List</h6>
							</div>
						</div>
						<div class="card-body px-0 pb-2">
							<div class="table-responsive p-0">
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Name</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Contact</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Designation</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status</th>
									...
									<tbody>
										<%
										for (User user : userList) {
											if (user.getType().equals("TEACHER") && user.getStatus().equals("Approved")) {
										%>
										<tr>
											<td>
												<div class="d-flex px-2 py-1">
											...
											<td>
												<p class="text-xs font-weight-bold mb-0"><%=user.getContact()%></p>
											</td>
											<td>
												<p class="text-xs font-weight-bold mb-0"><%=user.getType()%></p>
											</td>
							...
							<div class="table-responsive p-0">
								<table
									...
									<thead>
										<tr>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Project</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Budget</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Status</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Completion</th>
											<th></th>
										</tr>
									</thead>
									<tbody>
										<tr>
											...
											<td><span class="text-xs font-weight-bold">working</span>
											</td>
										...
										<tr>
											...
											<td><span class="text-xs font-weight-bold">canceled</span>
											</td>
											<td class="align-middle text-center">
												<div
													class="d-flex align-items-center justify-content-center">
